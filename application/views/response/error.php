...
<style>
    ...
    * {
    ...
    .topHalf {
        ...
        background: -webkit-linear-gradient(45deg, #b43e3e, #ff0000)
    }
    ...
    <div class="wrapperAlert">
        ...
        <div class="contentAlert">
            ...
            <div class="topHalf">
                ...
                <p><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="100" title="check-circle">
            ...
            <div class="bottomHalf">
                <p>Mohon Maaf<br>Pembayaran anda tidak terkirim</p>
                <a href="<?= base_url('home') ?>">
                    <button id="alertMO"> Kembali</button>
                </a>
            </div>
        </div>
    </div>
